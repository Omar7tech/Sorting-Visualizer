...
export default function Home() {
  ...
  return (
    <main className="absolute top-0 h-screen w-screen z-[-2] bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#150222_1px)] bg-[size:40px_40px]">
      <div className="flex h-full justify-center">
        ...
        >
          <div className="h-[66px] relative flex items-center justify-between w-full">
            <h1 className="text-2xl font-light hidden md:flex" id="title">
              Sortify7
            </h1>
            <p className="text-gray-300 text-2xl font-light hidden md:flex">
              <a href="http://code7-v2.netlify.app">Try Code7 editor!</a>
            </p>
      ...
      <footer className="absolute bottom-0 w-full text-center py-2 text-gray-500">
        <p>
          Developer: Omar Abi Farraj - Omar7Tech | Email: omar7tech<span className="lowercase">@</span>gmail.com | &#169; 2024
        </p>
      </footer>
    </main>
  );
